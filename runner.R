...
source("05_purrr_map.R")           # 715.63 sec elapsed
...
source("06_furrr_future_map.R")    # 120.25 sec elapsed
source("07_parLapply.R")           # 22.83 sec elapsed
source("08_foreach.R")             # 122.93 sec elapsed
# source("09_mclapply.R") does not work for more than 1 core on windows
